...
class DataTrainingArguments:
    ...
    train_file: Optional[Union[str, list]] = field(
        default=None, metadata={"help": "The input training data file (a text file)."}
    )
    validation_file: Optional[Union[str, list]] = field(
        default=None,
        metadata={
    ...
    whole_word_mask: bool = field(
        default=False,
        metadata={
            "help:": "setting for whole word mask (for more information, please reference)"
